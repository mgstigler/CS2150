...
/**
 * The names of all cities in Middle-Earth
 */
 ...
 * @param xsize of MiddleEarth x axis
 * @param ysize of MiddleEarth y axis
 * @param num_cities the number of cities in MiddleEarth
 * @param seed to set up the random number seed
 * 
 * 
 */
 ...
 * 
 * Sauron, the destructor of Middle-Earth, destroys Middle-Earth instances
 */
 ...
 * 
 * The Mouth of Sauroun printing Middle-Earth
 * 
 */
...
/** @brief prints a tab-separated table of distances
 * 
 * Prints a table of distances between the cities of Middle-Earth
 * 
 */
...
/** @brief returns the distance between cities
 * 
 * returns the distance between two cities from an array
 * @return float distance between 2 cities
 ...
 * 
 * Returns a vector list of cities from start point to end point.  Number passed does not include the start/end point
